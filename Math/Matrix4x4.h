...
#define VOS_MATH_MATRIX4X4_HEADER
    ...
    class Matrix4x4
    {
        public:
            ...
            ////////////////////////////////////////////////////////////////////
            //  Reset Matrix4x4 to default identity                           //
            ////////////////////////////////////////////////////////////////////
            void reset()
            {
                mat[0] = 1.0f;
                ...
                float fovy, float ratio, float znear, float zfar)
            {
                ...
                float frustHeight = (std::tan((fovy/360.0f)*Math::Pi))*znear;
            ...
            void rotate(float angle, float x, float y, float z)
            {
                ...
                float sinAngle = std::sin(angle*Math::Pi / 180.0f);
                float cosAngle = std::cos(angle*Math::Pi / 180.0f);
