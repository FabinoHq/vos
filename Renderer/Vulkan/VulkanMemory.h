...
#define VOS_RENDERER_VULKAN_VULKANMEMORY_HEADER
    ...
    const VulkanMemoryList VulkanMemoryArray[VULKAN_MEMORY_POOLSCOUNT] =
    {
        ...
        VULKAN_MEMORY_HEIGHTMAPUPLOAD, VULKAN_MEMORY_HOST, 0x10000000,
        VULKAN_MEMORY_HEIGHTFARUPLOAD, VULKAN_MEMORY_HOST, 0x10000000,

        VULKAN_MEMORY_UNIFORMS, VULKAN_MEMORY_DEVICE, 0x100000,
        VULKAN_MEMORY_TEXTURES, VULKAN_MEMORY_DEVICE, 0x20000000,
        VULKAN_MEMORY_MESHES, VULKAN_MEMORY_DEVICE, 0x20000000,
        VULKAN_MEMORY_HEIGHTMAPS, VULKAN_MEMORY_DEVICE, 0x20000000,
        VULKAN_MEMORY_HEIGHTFARS, VULKAN_MEMORY_DEVICE, 0x20000000
    };
