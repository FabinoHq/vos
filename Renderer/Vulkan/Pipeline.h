...
#define VOS_RENDERER_VULKAN_PIPELINE_HEADER
    ...
    enum RendererPipeline
    {
        ...
        RENDERER_PIPELINE_SLIDER = 9,

        RENDERER_PIPELINE_SKYBOX = 10,
        RENDERER_PIPELINE_STATICPROC = 11,
        RENDERER_PIPELINE_STATICMESH = 12,
        RENDERER_PIPELINE_HEIGHTMAP = 13,
        RENDERER_PIPELINE_HEIGHTFAR = 14,
        RENDERER_PIPELINE_SEANEAR = 15,
        RENDERER_PIPELINE_SEAFAR = 16,

        RENDERER_PIPELINE_PIPELINESCOUNT = 17
    };
