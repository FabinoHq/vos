...
#define VOS_RENDERER_VULKAN_PIPELINE_HEADER
    ...
    enum RendererPipeline
    {
        ...
        RENDERER_PIPELINE_SKYBOX = 8,
        RENDERER_PIPELINE_SHAPE = 9,
        RENDERER_PIPELINE_STATICMESH = 10,
        RENDERER_PIPELINE_HEIGHTMAP = 11,
        RENDERER_PIPELINE_HEIGHTFAR = 12,
        RENDERER_PIPELINE_SEANEAR = 13,
        RENDERER_PIPELINE_SEAFAR = 14,

        RENDERER_PIPELINE_PIPELINESCOUNT = 15
    };
