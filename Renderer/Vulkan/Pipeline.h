...
#define VOS_RENDERER_VULKAN_PIPELINE_HEADER
    ...
    enum RendererPipeline
    {
        ...
        RENDERER_PIPELINE_SCROLLBAR = 9,
        RENDERER_PIPELINE_SLIDER = 10,

        RENDERER_PIPELINE_SKYBOX = 11,
        RENDERER_PIPELINE_STATICPROC = 12,
        RENDERER_PIPELINE_STATICMESH = 13,
        RENDERER_PIPELINE_HEIGHTMAP = 14,
        RENDERER_PIPELINE_HEIGHTFAR = 15,
        RENDERER_PIPELINE_SEANEAR = 16,
        RENDERER_PIPELINE_SEAFAR = 17,

        RENDERER_PIPELINE_PIPELINESCOUNT = 18
    };
