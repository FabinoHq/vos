...
#define VOS_RENDERER_VULKAN_PIPELINE_HEADER
    ...
    enum RendererPipeline
    {
        ...
        RENDERER_PIPELINE_SKYBOX = 7,
        RENDERER_PIPELINE_SHAPE = 8,
        RENDERER_PIPELINE_STATICMESH = 9,
        RENDERER_PIPELINE_HEIGHTMAP = 10,
        RENDERER_PIPELINE_HEIGHTFAR = 11,
        RENDERER_PIPELINE_SEANEAR = 12,
        RENDERER_PIPELINE_SEAFAR = 13,

        RENDERER_PIPELINE_PIPELINESCOUNT = 14
    };
