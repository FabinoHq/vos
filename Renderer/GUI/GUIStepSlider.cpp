...
//     Renderer/GUI/GUIStepSlider.cpp : GUI Step slider management            //
////////////////////////////////////////////////////////////////////////////////
#include "GUIStepSlider.h"


////////////////////////////////////////////////////////////////////////////////
//  GUIStepSlider default constructor                                         //
////////////////////////////////////////////////////////////////////////////////
GUIStepSlider::GUIStepSlider() :
Transform2(),
m_texture(0),
...
////////////////////////////////////////////////////////////////////////////////
bool GUIStepSlider::init(Texture& texture, float width, float height,
...
////////////////////////////////////////////////////////////////////////////////
bool GUIStepSlider::setTexture(Texture& texture)
{
    // Check texture handle
    if (!texture.isValid())
    {
...
//  Set slider color                                                          //
////////////////////////////////////////////////////////////////////////////////
void GUIStepSlider::setColor(const Vector4& color)
{
...
//  Set slider color                                                          //
////////////////////////////////////////////////////////////////////////////////
void GUIStepSlider::setColor(float red, float green, float blue, float alpha)
{
    m_color.vec[0] = red;
    m_color.vec[1] = green;
    m_color.vec[2] = blue;
...
////////////////////////////////////////////////////////////////////////////////
bool GUIStepSlider::mouseMove(float mouseX, float mouseY)
{
    // Disabled state
...
////////////////////////////////////////////////////////////////////////////////
bool GUIStepSlider::mousePress(float mouseX, float mouseY)
{
    // Disabled state
    if (m_disabled) { m_state = GUISTEPSLIDER_NONE; return false; }
...
////////////////////////////////////////////////////////////////////////////////
bool GUIStepSlider::mouseRelease(float mouseX, float mouseY)
{
    // Disabled state
    if (m_disabled) { m_state = GUISTEPSLIDER_NONE; return false; }
...
////////////////////////////////////////////////////////////////////////////////
void GUIStepSlider::mouseWheel(int mouseWheel)
{
    // Disabled state
    if (m_disabled) { m_state = GUISTEPSLIDER_NONE; return; }

    // Mouse wheel event
    if (m_state == GUISTEPSLIDER_HOVER)
    {
        if (mouseWheel > 0)
        {
            // Mouse wheel up
...
//  Render slider                                                             //
////////////////////////////////////////////////////////////////////////////////
void GUIStepSlider::render()
{
    // Disabled state
    if (m_disabled) { m_state = GUISTEPSLIDER_NONE; }
    ...
    switch (m_state)
    {
        case GUISTEPSLIDER_HOVER:
        case GUISTEPSLIDER_PRESSED:
        case GUISTEPSLIDER_PRESSEDHOVER:
...
////////////////////////////////////////////////////////////////////////////////
void GUIStepSlider::computeSliderValue(float mouseX, float mouseY)
{
    if (m_vertical)
    {
        // Vertical slider
