    ...
    uint32_t surfaceQueueIndex)
{
    ...
    if (!physicalDevice)
    {
        ...
        SysMessage::box() << "[0x3012] Invalid physical device\n";
    ...
    if (!vulkanDevice)
    {
        ...
        SysMessage::box() << "[0x3013] Invalid Vulkan device\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if (!vulkanSurface)
    {
        ...
        SysMessage::box() << "[0x3014] Invalid Vulkan surface\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if (vkDeviceWaitIdle(vulkanDevice) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3015] Could not get the device ready\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        physicalDevice, vulkanSurface, &surfaceCapabilities) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3016] Could not get surface capabilities\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        physicalDevice, vulkanSurface, &formatsCnt, 0) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3017] Could not get surface formats count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    if (formatsCnt <= 0)
    {
        ...
        SysMessage::box() << "[0x3018] No surface formats found\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        vulkanSurface, &formatsCnt, surfaceFormats.data()) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3019] Could not get surface formats\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        physicalDevice, vulkanSurface, &presentModesCnt, 0) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x301A] Could not get present modes count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    if (presentModesCnt <= 0)
    {
        ...
        SysMessage::box() << "[0x301B] No present modes found\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        vulkanSurface, &presentModesCnt, presentModes.data()) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x301C] Could not get present modes\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if (imagesCount <= 0)
    {
        ...
        SysMessage::box() << "[0x301D] Invalid swapchain images count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if (surfaceFormats.size() <= 0)
    {
        ...
        SysMessage::box() << "[0x301E] Invalid surface formats count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if ((swapchainExtent.width <= 0) || (swapchainExtent.height <= 0))
    {
        ...
        SysMessage::box() << "[0x301F] Invalid swapchain extents\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT))
    {
        ...
        SysMessage::box() << "[0x3020] Color attachment is not supported\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if (!immediateModeFound)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                SysMessage::box() << "[0x3021] No present mode is supported\n";
                SysMessage::box() << "Please update your graphics drivers";
                return false;
            }
        }
        ...
        vulkanDevice, &swapchainInfos, 0, &handle) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3022] Could not create Vulkan swapchain\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        vulkanDevice, handle, &swapchainFramesCount, 0) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3023] Could not get swapchain frames count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    if (swapchainFramesCount <= 0)
    {
        ...
        SysMessage::box() << "[0x3024] Invalid swapchain frames count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    {
        // Invalid swapchain frames count
        SysMessage::box() << "[0x3025] Invalid swapchain frames count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        handle, &swapchainFramesCount, swapchainImages) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3026] Could not get swapchain images count\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    for (uint32_t i = 0; i < frames; ++i)
    {
            ...
            vulkanDevice, &imageView, 0, &views[i]) != VK_SUCCESS)
        {
            ...
            SysMessage::box() << "[0x3027] Could not create swapchain view\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
    }
        ...
        vulkanDevice, &renderPassInfo, 0, &renderPass) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3028] Could not create render pass\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    if (!renderPass)
    {
        // Invalid render pass
        SysMessage::box() << "[0x3029] Invalid render pass\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    for (uint32_t i = 0; i < frames; ++i)
    {
            ...
            vulkanDevice, &framebufferInfo, 0, &framebuffers[i]) != VK_SUCCESS)
        {
            ...
            SysMessage::box() << "[0x302A] Could not create framebuffer\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
        if (!framebuffers[i])
        {
            // Invalid framebuffer
            SysMessage::box() << "[0x302B] Invalid framebuffer\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
    }
    ...
    for (uint32_t i = 0; i < frames; ++i)
    {
            ...
            vulkanDevice, &semaphoreInfo, 0, &renderReady[i]) != VK_SUCCESS)
        {
            ...
            SysMessage::box() << "[0x302C] Could not create ready semaphore\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
            ...
            vulkanDevice, &semaphoreInfo, 0, &renderFinished[i]) != VK_SUCCESS)
        {
            ...
            SysMessage::box() << "[0x302D] Could not create finish semaphore\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
    }
    ...
    for (uint32_t i = 0; i < frames; ++i)
    {
            ...
            vulkanDevice, &fenceInfo, 0, &fences[i]) != VK_SUCCESS)
        {
            ...
            SysMessage::box() << "[0x302E] Could not create fence\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
        if (!fences[i])
        {
            // Invalid fence
            SysMessage::box() << "[0x302F] Invalid fence\n";
            SysMessage::box() << "Please update your graphics drivers";
            return false;
        }
    }
        ...
        vulkanDevice, &commandPoolInfo, 0, &commandsPool) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3030] Could not create commands pool\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    if (!commandsPool)
    {
        ...
        SysMessage::box() << "[0x3031] Invalid commands pool\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
        ...
        vulkanDevice, &commandBufferInfo, commandBuffers) != VK_SUCCESS)
    {
        ...
        SysMessage::box() << "[0x3032] Could not allocate command buffers\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
    ...
    {
        // Could not get the device ready
        SysMessage::box() << "[0x3033] Could not get the device ready\n";
        SysMessage::box() << "Please update your graphics drivers";
        return false;
    }
