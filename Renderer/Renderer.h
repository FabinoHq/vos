...
#define VOS_RENDERER_RENDERER_HEADER
    ...
    ////////////////////////////////////////////////////////////////////////////
    const float RendererMaxFramerate = 300.0f;
    const float RendererTickTime = (1.0f / RendererMaxFramerate);
    const double RendererRunSleepTime = 0.001;
