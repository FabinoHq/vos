...
#define VOS_RENDERER_SEANEARCHUNK_HEADER
    ...
    ////////////////////////////////////////////////////////////////////////////
    const uint16_t SeaNearChunkWidth = 256;
    const uint16_t SeaNearChunkHeight = 256;
    const float SeaNearChunkPlaneWidth = 2.0f;
    const float SeaNearChunkPlaneHeight = 2.0f;
    const float SeaNearChunkXStride = 512.0f;
    const float SeaNearChunkZStride = 512.0f;
    const float SeaNearChunkTexcoordsWidth = 256.0f;
    const float SeaNearChunkTexcoordsHeight = 256.0f;
