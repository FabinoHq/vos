...
#define VOS_SYSTEM_SYSMEMORY_HEADER
    ...
    //  CRC Table                                                             //
    ////////////////////////////////////////////////////////////////////////////
    const uint32_t SysMemoryCRCTable[] =
    {
    ...
    ////////////////////////////////////////////////////////////////////////////
    //  Update CRC with bytes from a buffer                                   //
    //  return : Updated CRC                                                  //
    ////////////////////////////////////////////////////////////////////////////
    inline uint32_t SysMemoryUpdateCRC(
        uint32_t crc, unsigned char* buffer, size_t size)
    {
        for (size_t i = 0; i < size; ++i)
        {
            crc = SysMemoryCRCTable[(crc^buffer[i]) & 0xFF] ^ (crc >> 8);
        }
        return crc;
    }

    ////////////////////////////////////////////////////////////////////////////
    //  Compute CRC with bytes from a buffer                                  //
    //  return : Computed CRC                                                 //
    ////////////////////////////////////////////////////////////////////////////
    inline uint32_t SysMemoryCRC(unsigned char* buffer, size_t size)
    {
        return (SysMemoryUpdateCRC(0xFFFFFFFFu, buffer, size) ^ 0xFFFFFFFFu);
    }
